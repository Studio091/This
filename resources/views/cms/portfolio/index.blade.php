			...
			<li>
				<div class="chat-body clearfix">
					...
					<p>
                                            {{$c->text}}<br>
                        @if($c->id != 8)
<a href="/cms/portfolio/delete/{{$c->id}}">Delete</a>
@endif | <a href="/cms/portfolio/{{$c->id}}">Edit</a>
                                        </p>
                                    </div>
                                </li>
                                @endforeach
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-12">
                                       ...
                                       @if($option == true)
<form action="/cms/portfolio" method="post">
 {{ csrf_field() }}
...
@else
<form action="/cms/portfolio/{{$edit->id}}" method="post">
 {{ csrf_field() }}
	 <div class="form-group">
		<label>Title:</label>
